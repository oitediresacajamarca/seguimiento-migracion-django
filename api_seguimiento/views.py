...
class consulta(View):
    def get(self, request,agnio,mes,ipress):
        ...
        table_i= connection.table('PERIODO_'+str(periodo)+':SEGUIMIENTO_MATERNO')
       
       
        lisg={}
        for key, data in table_i.scan(filter="SingleColumnValueFilter('1_6','ipress',=, 'binary:000004645')"):
            dicc_data={}          
